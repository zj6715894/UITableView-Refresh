...
extension UIScrollView {
    func addHeaderWithCallback( callback:(() -> Void)!){
        ...
        header.mas_makeConstraints { (make:MASConstraintMaker!) -> Void in
            make.left.equalTo()(0)
            make.right.equalTo()(UIScreen.mainScreen().bounds.width)
   ...
   func addFooterWithCallback( callback:(() -> Void)!){
        ...
        footer.mas_makeConstraints { (make: MASConstraintMaker!) -> Void in
            make.left.equalTo()(0)
            make.right.equalTo()(UIScreen.mainScreen().bounds.width)
            make.height.equalTo()(64)
            make.top.equalTo()(self.frame.size.height)
        }
